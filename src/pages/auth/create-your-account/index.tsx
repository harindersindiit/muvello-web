...
const CreateYourAccount = () => {
  return (
    <div className="min-h-screen bg-black text-white flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-3 py-20">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-grey text-md font-light text-center">
              Sign up now to kickstart your fitness journey, connect <br /> with coaches, and stay inspired by others.
            </p>
          </div>
          <LoginForm />
        </div>
